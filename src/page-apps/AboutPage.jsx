            ...
            <div className='pt-- px-- flex v row-gap-'>
              <Article>
                <Article.Header className='flex h primary border-b border-grey items-end'>
                  <h3>++&nbsp;<i className='fa-solid fa-rocket secondary'></i>&nbsp;Game Launch</h3>
                  <div className='flex pb pl-- end items-end'><small>May 8th, 2026</small></div>
                </Article.Header>
                <div className='pt-- px-- flex v row-gap- small grey'>
                  ...
                  <ul className='mono light-grey'>
                    <li>- Created first playable game page</li>
                  </ul>
                </div>
              </Article>
